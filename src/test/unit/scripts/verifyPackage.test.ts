...
describe('Verification Script (Regression)', () => {
    ...
    it('should pass with valid file list', () => {
        ...
        expect(consoleLogStub).toHaveBeenCalledWith(expect.stringMatching(/✅ Package verification passed!/));
    });
    ...
    it('should fail when sensitive files are included (.env)', () => {
        ...
        expect(consoleErrorStub).toHaveBeenCalledWith(expect.stringMatching(/Forbidden file included: .env/));
    });
    ...
    it('should fail when sensitive files are included (.env.local)', () => {
        ...
        expect(processExitStub).toHaveBeenCalledWith(1);
        expect(consoleErrorStub).toHaveBeenCalledWith(expect.stringMatching(/Forbidden file included: .env.local/));
    });
    ...
    it('should fail when node_modules are included excessively', () => {
        ...
        expect(processExitStub).toHaveBeenCalledWith(1);
        expect(consoleErrorStub).toHaveBeenCalledWith(expect.stringMatching(/Too many node_modules files included/));
    });
